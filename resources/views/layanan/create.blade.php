                    ...
                    <form action="{{ route('layanan.store') }}" method="POST">
                        ...
                        <div class="mb-4 block">
                            ...
                            <textarea name="deskripsi" id="deskripsi" rows="3"
                                class="border-gray-300 focus:border-indigo-500 :border-indigo-600 focus:ring-indigo-500 :ring-indigo-600 rounded-md shadow-sm block mt-1 w-full">{{ old('deskripsi') }}</textarea>
