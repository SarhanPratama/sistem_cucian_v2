<x-app-layout>
 ...
 <x-text-input id="nama" class="block mt-1 w-full" type="text" name="nama" :value="old('nama', $karyawan->nama)" required autofocus />
 ...
 <x-text-input id="no_hp" class="block mt-1 w-full" type="text" name="no_hp" :value="old('no_hp', $karyawan->no_hp)" required />
 ...
 <select name="status" id="status" class="border-gray-300 focus:border-indigo-500 :border-indigo-600 focus:ring-indigo-500 :ring-indigo-600 rounded-md shadow-sm block mt-1 w-full" required>
 ...
 @if($karyawan->foto)
 <div class="mt-2 mb-2">
 <img src="{{ asset('storage/' . $karyawan->foto) }}" alt="Foto {{ $karyawan->nama }}" class="h-20 w-20 rounded-full object-cover">
 </div>
 @endif
