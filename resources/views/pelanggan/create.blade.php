        ...
        <div class="flex flex-col gap-1 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500">
                    {{ __('Masukkan detail pelanggan baru sehingga histori transaksi bisa dicatat.') }}
                </p>
            </div>
                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('pelanggan.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="alamat" id="alamat" rows="3" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">{{ old('alamat') }}</textarea>
